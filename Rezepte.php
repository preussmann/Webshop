...
function einloggen( $KundenNr, $Passwort ) {
	...
	if($_SESSION['logged_in'] == true){
		header("Location:Rezepte_secured.php");
	}
                        ...
                        <!-- Registrierung content-->
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      <p>
                                        <form name="Registrierung" action="index.php" method="post">
                                            <fieldset>
                                                ...
                                                <input id="NN" type="text" name="Nachname" placeholder="Ihr Nachname" required 
                                                class="btn btn-default btn-sm" /><br>
                                                <label for="VN">Vorname:</label>
                                                <input id="VN" type="text" name="Vorname" placeholder="Ihr Vorname" required  
                                            ...
                                            <fieldset>
                                                ...
                                                <input id="EM" type="email" name="EMail" placeholder="Ihre E-Mail-Adresse" required 
                                                class="btn btn-default btn-sm"/></br><p></p>
                                                <label for="KW">Passwort:</label>
                                                <input id="KW" type="password" name="Passwort" class="btn btn-default btn-sm"/><br>
                                                <label for="KT">Bestätigung:</label> 
                                                <input id="KT" type="password" name="Kontrolle" class="btn btn-default btn-sm"/><p></p>
                                            </fieldset>
                                            <fieldset>
                                                <label for="RG"></label>
                                                <input id="RG" type="submit" name="Aktion" value="registrieren" 
                                                class="btn btn-default btn-sm"/>
                                            </fieldset>
                                        </form>
                                    </p>
                	...
                	<div class="col-md-8 col-xs-2 col-sm-10 col-lg-8 col-xl-10 col-md-offset-2 col-xs-offset-5 col-sm-offset-1 col-lg-offset-2 col-xl-offset-1 text-center">
                        <nav class="blog-nav">
                                        <fieldset>
                                            ...
                                            <a href="produkte.php" class="blog-nav-item btn btn-default
                                            btn-sm">Produkte 
                                            </a>
...
<div class="container-fluid main"> 
       			<div class="row ">
					<div class="text-center col-md-12 col-xs-2 col-sm-12 col-lg-12 col-xl-10 col-md-offset-0 col-xs-offset-5 col-sm-offset-0 col-lg-offset-0 col-xl-offset-1 blog-main">
                        ...
                        Viele der Zutaten finden sie auch in unserem <a href="Artikel.php">Shop</a>. 
                        <br>
                        </p>
