...
function registrieren( $Anrede, $Nachname, $Vorname, $Anschrift, $EMail, $Passwort ) {
	...
	// Aufbau eines Statemen t-Objektes auf der DB-Verbindung 
...
function einloggen( $KundenNr, $Passwort ) {
	...
	if($_SESSION['logged_in'] == true){
		header("Location:index_secured.php");
	}
...
if(isset($_SESSION['mregistration']) && $_SESSION['mregistration'] == true ){ ?>
                                        ...
                                        <!-- Registrierung content-->
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                      <p>
                                                        <form name="Registrierung" action="index.php" method="post" enctype="multipart/form-data">
                                                            <fieldset>
				...
				<div class="siegel row">
                                        ...
                                        <fieldset>
                                            ...
                                            <input id="PW" type="password" name="Passwort" placeholder="Passwort" required class="btn btn-default btn-sm"/>
                                      		<div>
                                               ...
                                               <button id="LI" type="button" data-toggle="modal" data-target="#myModal" name="Aktion" value="einloggen" class="btn btn-default btn-sm">
              	...
              	<div class="row">
                    <nav class="col-md-12 col-xs-2 col-sm-4 col-lg-8 col-xl-10 col-md-offset-0 col-xs-offset-5 col-sm-offset-4 col-lg-offset-2 col-xl-offset-1 text-center">
                        <p><?php if( isset($Meldung) ) echo( $Meldung ) ; ?>
                        <?php if( isset($SESSION['Meldung']) ) echo( $SESSION['Meldung'] ) ; ?>
                        <?php if( isset($_SESSION['mregistration']) ) echo( $_SESSION['mregistration'] ) ; ?></p>
                    </nav>
                </div>
